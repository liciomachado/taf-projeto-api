...
import com.rest.taf.repositories.ExercicioRepository;
...
public class ExercicioServiceImpl implements ExercicioService{
	...
	public List<IndicePorExercicio> buscaIndiceDoExercicio(Exercicio exercicio, List<Indices> findByIdadeAndGenero) {
		...
		for (Indices indices : findByIdadeAndGenero) {
			if (indices.getExerciciosDoTaf() == ExerciciosDoTaf.CORRIDA) {
				...
				newIPE.setIdade(exercicio.getUsuario().geraIdadeUsuario());
	...
	public IndiceTaf defineIndicePorResultadosDeExercicios(List<IndicePorExercicio> indicesExaminados){
